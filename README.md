...
| <a name="input_default_network_acl_egress_rules"></a> [default\_network\_acl\_egress\_rules](#input\_default\_network\_acl\_egress\_rules) | Egress rules to be added to the Default Network ACL | `list(map(string))` | `[]` | no |
| <a name="input_default_network_acl_ingress_rules"></a> [default\_network\_acl\_ingress\_rules](#input\_default\_network\_acl\_ingress\_rules) | Ingress rules to be added to the Default Network ACL | `list(map(string))` | `[]` | no |
