...
| <a name="input_firewall_policy_resource_policy_template_path"></a> [firewall\_policy\_resource\_policy\_template\_path](#input\_firewall\_policy\_resource\_policy\_template\_path) | The path to the Firewall Policy IAM resource policy template | `string` | `""` | no |
...
| <a name="input_rule_group_resource_policies"></a> [rule\_group\_resource\_policies](#input\_rule\_group\_resource\_policies) | A map of Firewall Rule Group resource policies to be created | `any` | `{}` | no |
