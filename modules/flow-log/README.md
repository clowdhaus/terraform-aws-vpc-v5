...
| <a name="input_create_cloudwatch_iam_role"></a> [create\_cloudwatch\_iam\_role](#input\_create\_cloudwatch\_iam\_role) | Determines whether a an IAM role is created or to use an existing IAM role | `bool` | `true` | no |
...
| <a name="input_eni_id"></a> [eni\_id](#input\_eni\_id) | The ID of the ENI to attach the flow log to | `string` | `""` | no |
...
| <a name="input_subnet_id"></a> [subnet\_id](#input\_subnet\_id) | The ID of the subnet to attach the flow log to | `string` | `""` | no |
...
| <a name="input_vpc_id"></a> [vpc\_id](#input\_vpc\_id) | The ID of the VPC to attach the flow log to | `string` | `""` | no |
