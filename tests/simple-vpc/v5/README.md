...
| <a name="output_public_route_table_id"></a> [public\_route\_table\_id](#output\_public\_route\_table\_id) | List of IDs of public route tables |
...
| <a name="output_vgw_arns"></a> [vgw\_arns](#output\_vgw\_arns) | The ARN of the VPN Gateway |
| <a name="output_vgw_ids"></a> [vgw\_ids](#output\_vgw\_ids) | The ID of the VPN Gateway |
